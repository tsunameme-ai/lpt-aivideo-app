...
import { Card, CardBody, CardHeader, Divider, Input, Image, Modal, ModalBody, ModalContent, ModalFooter, ModalHeader, Spacer, Textarea, SelectItem, Select, Checkbox } from '@nextui-org/react'
import { useState } from "react"
import { API } from '@/api/api'
import { Txt2imgInput, VideoGenerationOutput, SDModels } from '@/api/types'
